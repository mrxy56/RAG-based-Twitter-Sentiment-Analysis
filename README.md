...
- Results depend on the available tweets
- Small language models may generate imperfect answers
- Sentiment analysis may struggle with sarcasm and slang
- Tweets are individual opinions, not verified facts

## Purpose

This project was created for educational purposes to demonstrate sentiment analysis, vector databases, semantic retrieval, RAG, and evaluation.
